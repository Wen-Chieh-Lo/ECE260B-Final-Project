...
#  Created on Sun Mar  1 12:23:30 2026                
#                                                     
#######################################################
...
set init_verilog ./syn/gate/core.out.v
...
set_interactive_constraint_modes {CON}
setDesignMode -process 65
floorPlan -site core -r 1 0.65 20 20 20 20
...
saveDesign floorplan.enc
saveDesign -tclMode floorplan.enc
...
create_ccopt_clock_tree_spec -file ../../syn/gate/constraints/core.ccopt
ccopt_design
verifyConnectivity
verify_drc
checkFPlan
