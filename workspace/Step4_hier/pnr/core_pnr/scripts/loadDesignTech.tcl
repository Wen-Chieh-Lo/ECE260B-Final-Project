...
set init_lef_file "$lef ../../sram_pnr_64b/scripts/sram_w16.lef ../../sram_pnr_160b/scripts/sram_160b_w16.lef"

# MCMM setup
create_library_set -name WC_LIB -timing "$worst_timing_lib ../../sram_pnr_64b/scripts/sram_w16_WC.lib ../../sram_pnr_160b/scripts/sram_160b_w16_WC.lib"
create_library_set -name BC_LIB -timing "$best_timing_lib ../../sram_pnr_64b/scripts/sram_w16_BC.lib ../../sram_pnr_160b/scripts/sram_160b_w16_BC.lib"
